...
def RandKawpro(typefoodkaw):
    ...
    label1 = tk.Label(master=w10,font=('Luckiest Guy', 30),text='Meat Dish',
                   fg='white', bg='#33A1C9').pack(pady=(30,5))
    label2 = tk.Label(
        master=w10,font=('Mali Regular', 17),text="อาหารคาว", fg='white', bg='#33A1C9').pack(pady=5)

    name = name1.get()
    age = selectage(name)
    lbfrk=tk.Label(master=w10,bg='white',fg='black',font=('Mali Regular',25),text='')
    lbfrk.pack(pady=(150,50))
    def process():
        if age >= 5 and age <= 13:
    ...
    btr = tk.Button(master=w10, text="สุ่มใหม่", fg='black', bg='#33A1C9',highlightbackground='#33A1C9', font=(
        'Mali Regular', 14), command=process).pack(pady=(25,15))
    btk = tk.Button(master=w10, text="Back", fg='black', bg='#33A1C9',highlightbackground='#33A1C9', font=(
...
def RandKawform():
    ...
    label1 = tk.Label(master=w9,font=('Luckiest Guy', 30),text='Type of food',
                   fg='white', bg='#33A1C9').pack(pady=25)
    label2 = tk.Label(
        master=w9,font=('Mali Regular', 17),text="เลือกประเภทของอาหารที่คุณต้องการ", fg='white', bg='#33A1C9').pack()

    bttk1 = tk.Button(master=w9, text="แกง", fg='black',bd=1, bg='#33A1C9', font=(
        'Mali Regulary', 14),height=3,width=15,highlightbackground='black', command=lambda: RandKawf("แกง")).pack(pady=(50,10))
    bttk2 = tk.Button(master=w9, text="ผัด",fg='black',bd=1, bg='#33A1C9', font=(
        'Mali Regular', 14),height=3,width=15, highlightbackground='black',command=lambda: RandKawf("ผัด")).pack(pady=10)
    bttk3 = tk.Button(master=w9, text="ทอด", fg='black',bd=1,bg='#33A1C9', font=(
        'Mali Regular', 14),height=3,width=15,highlightbackground='black',command=lambda: RandKawf("ทอด")).pack(pady=10)
    bttk4 = tk.Button(master=w9, text="ต้ม นึ่ง หรือตุ๋น",bd=1,fg='black', bg='#33A1C9', font=(
        'Mali Regular', 14),height=3,width=15,highlightbackground='black',command=lambda: RandKawf("ต้ม นึ่ง หรือตุ๋น")).pack(pady=10)

    btk = tk.Button(master=w9, text="Back", fg='black',highlightbackground='#33A1C9', bg='#33A1C9', font=(
        'Luckiest Guy', 14), command=Back).pack(pady=30)
...
def RandWanpro(typefoodwan):
    ...
    label1 = tk.Label(master=w8,font=('Luckiest Guy', 30),text='Dessert',
                   fg='white', bg='#33A1C9').pack(pady=(30,5))
    label2 = tk.Label(
        master=w8,font=('Mali Regular', 17),text="ของหวาน", fg='white', bg='#33A1C9').pack()

    name = name1.get()
    age = selectage(name)
    lbfrw=tk.Label(master=w8,bg='white',fg='black',font=('Mali Regular',25),text='')
    lbfrw.pack(pady=(150,50))
    def process():
        if age >= 5 and age <= 13:
    ...
    btr = tk.Button(master=w8, text="สุ่มใหม่",highlightbackground='#33A1C9', fg='black', bg='#33A1C9', font=(
        'Mali Regular', 14), command=process).pack(pady=(25,15))
    btk = tk.Button(master=w8, text="Back",highlightbackground='#33A1C9', fg='black', bg='#33A1C9', font=(
        'Luckiest Guy', 14), command=Back).pack(pady=5)
...
def RandWanform():
    ...
    label1 = tk.Label(master=w7,font=('Luckiest Guy', 30),text='Type of food',
                   fg='white', bg='#33A1C9').pack(pady=(30,5))
    label2 = tk.Label(
        master=w7,font=('Neucha', 17),text="เลือกประเภทของอาหารที่คุณต้องการ", fg='white', bg='#33A1C9').pack()
    
    bttw1 = tk.Button(master=w7,height=3,width=15,text="แบบน้ำ", fg='black',highlightbackground='black', bg='#33A1C9',bd=1, font=(
        'Mali', 14), command=lambda: RandWanf("น้ำ")).pack(pady=(150,5))
    bttw2 = tk.Button(master=w7,height=3,width=15,text="แบบแห้ง", fg='black',highlightbackground='black', bg='#33A1C9', bd=1,font=(
        'Mali', 14), command=lambda: RandWanf("แห้ง")).pack(pady=5)
...
def Random_food():
    ...
    label1 = tk.Label(master=w6,font=('Luckiest Guy', 35),text='Random food generator',
                   fg='white', bg='#33A1C9').pack(pady=15)
    label2 = tk.Label(master=w6,font=('Neucha', 20),text="let me help you decide what to eat for today !", fg='white', bg='#33A1C9').pack(pady=(5,55))

    btk1 = tk.Button(master=w6, text="อาหารคาว", fg='black', bg='#33A1C9',height=3,width=15,highlightbackground='black',font=(
        'Mali Regular', 14), command=RandKaw).pack(pady=(50,10))
    btk2 = tk.Button(master=w6, text="อาหารหวาน", fg='black', bg='#33A1C9',height=3,width=15,highlightbackground='black',font=(
        'Mali Regular', 14), command=RandWan).pack()

    btbk=tk.Button(master=w6, text="Back",fg='black',highlightbackground='#33A1C9',bg='#33A1C9',font=('Luckiest Guy', 14), command=Back).pack(pady=55)
    w6.mainloop()
...
def Calform():
    ...
    label1 = tk.Label(master=w5,font=('Luckiest Guy', 20),text='How many calories should you eat in a day?',
                   fg='white', bg='#33A1C9').pack(pady=(30,5))
    label2 = tk.Label(
        master=w5,font=('Mali Regular', 17),text="พลังงานแคลอรี่ที่คุณต้องการ", fg='white', bg='#33A1C9').pack()
    
    lbfr1=tk.Label(master=w5,font=('Mali Regular',17),text='แคลอรี่ที่ควรได้รับต่อวัน',fg='black',bg='white').pack(pady=(170,25))
    ...
    btbk=tk.Button(master=w5, text="Back",fg='black',bg='#33A1C9',font=('Luckiest Guy', 14), highlightbackground='#33A1C9', command=Back).pack(pady=35)
    w5.mainloop()
...
def forecastform():
    ...
    datetime=tk.Label(w4, text=(date.strftime('%d'))+' '+( date.strftime('%A'))+' '+( date.strftime('%B'))+' '+( date.strftime('%Y')), bg='white', fg='black',font=('Mali',13)).pack(pady=(25,5))
    hour=tk.Label(w4, text=(date.strftime('%H'))+' '+':'+' '+(date.strftime('%M')), bg='white', fg='black',font=('Mali',15)).pack(pady=5)
    gmt=tk.Label(w4, text='(GMT +7)',  bg='white', fg='black',font=('Mali',12)) .pack(pady=5)
    place=tk.Label(w4, text='Bangkok, Thailand',  bg='white', fg='black',font=('Anton-Regular',20)) .pack(pady=5)
    ...
    label1=tk.Label(w4, text='temperature',bg='white', fg='black', font=('Mali',15)).pack(pady=5)
    temp_field = tk.Label(w4, text="...", width=0, bg='white',font=("Mali", 40), fg='black')
    temp_field.pack(pady=5)
    label2=tk.Label(w4, text='Atmosperic Pressure :'+' '+str(current_pressure),bg='white', fg='black', font=('Mali',15)).pack(pady=(25,5))
    label4=tk.Label(w4, text='Humidity :'+' '+str(current_humidity),bg='white', fg='black', font=('Mali',15)).pack(pady=5)
    label5=tk.Label(w4, text='Description :'+' '+str(weather_description),bg='white', fg='black', font=('Mali',15)).pack(pady=5)
    ...
    bt1=tk.Button(master=w4, text=' BACK! ',fg='black',highlightbackground='#33A1C9',font=('Luckiest Guy', 14), command=backbt).pack(pady=35)
    w4.mainloop()
...
def bmiform():
    ...
    label1=tk.Label(master=w3,font=('Luckiest Guy',35),text='Body Mass Index : BMI',fg='white',bg='#33A1C9').pack(pady=(20,5))
    label2=tk.Label(master=w3,font=('Mali',11),text='BMI คือ ตัวชี้วัดมาตรฐานเพื่อประเมินสภาวะของร่างกายว่า\nมีความสมดุลของน้ำหนักตัวต่อส่วนสูงอยู่ในเกณฑ์ที่เหมาะสมหรือไม่',fg='white',bg='#33A1C9').pack(pady=5)
    
    name = name1.get()
    height = selectheight(name)
    lbh=tk.Label(master=w3,font=('Chonburi',14),text='ส่วนสูงของคุณ คือ',fg='black',bg='white').pack(pady=(50,5))
    lbh1=tk.Label(master=w3,font=('Mali',12),text=str(height)+' cm',fg='black',bg='white').pack(pady=5)
    
    weight = selectweight(name)
    lbw=tk.Label(master=w3,font=('Chonburi',14),text='น้ำหนักของคุณ คือ',fg='black',bg='white').pack(pady=5)
    lbw1=tk.Label(master=w3,font=('Mali',12),text=str(weight)+' kg',fg='black',bg='white').pack(pady=5)
    
    lbr=tk.Label(master=w3,font=('Chonburi',14),text='BMI ของคุณ คือ',fg='black',bg='white').pack(pady=5)
        
    result = weight/((height/100)**2)
    lbr1=tk.Label(master=w3,font=('Mali',12),text='{:.2f}'.format(result),fg='black',bg='white').pack(pady=15)
    if result >= 30:
        lbr2=tk.Label(master=w3,font=('Mali Regular',12),text="คุณอ้วนมาก ค่อนข้างอันตราย\nเสี่ยงต่อการเกิดโรคร้ายแรงที่แฝงมากับความอ้วน \nต้องปรับพฤติกรรมการทานอาหาร และควรเริ่มออกกำลังกาย \nและหากค่า BMI ยิ่งสูงกว่า 40.0 ยิ่งแสดงถึงความอ้วนที่มากขึ้น \nควรไปตรวจสุขภาพ และปรึกษาแพทย์"
                   .format(result),fg='black', bg='white').pack()
    elif (result >= 25.0) and (result <= 29.9):
        lbr2=tk.Label(master=w3,font=('Mali Regular',12),text="คุณอ้วนในระดับหนึ่ง ถึงแม้ว่าจะไม่ถึงเกณฑ์ที่ถือว่าอ้วนมากๆ\nแต่ก็ยังมีความเสี่ยงต่อการเกิดโรคที่มากับความอ้วนได้เช่นกัน \nทั้งโรคเบาหวาน และความดันโลหิตสูง \nควรปรับพฤติกรรมการทานอาหาร ออกกำลังกาย และตรวจสุขภาพ"
                   .format(result),fg='black', bg='white').pack()
    elif (result >= 18.6) and (result <= 24.0):
        lbr2=tk.Label(master=w3,font=('Mali Regular',12),text="คุณน้ำหนักปกติ จัดอยู่ในเกณฑ์ปกติ \nห่างไกลโรคที่เกิดจากความอ้วน \nและมีความเสี่ยงต่อการเกิดโรคต่างๆ น้อยที่สุด \nควรพยายามรักษาระดับค่า BMI ให้อยู่ในระดับยี้ให้นานที่สุด \nและควรตรวจสุขภาพทุกปี"
                   .format(result),fg='black', bg='white').pack()
    else:
        lbr2=tk.Label(master=w3,font=('Mali Regular',12),text="คุณผอมเกินไป น้ำหนักน้อยกว่าคนปกติ \nอาจเสี่ยงต่อการได้รับสารอาหารไม่เพียงพอหรือได้รับพลังงานไม่เพียงพอ \nส่งผลให้ร่างกายอ่อนเพลียง่าย การรับประทานอาหารให้เพียงพอ \nและออกกำลังกายเพื่อเสริมสร้างกล้ามเนื้อ\nสามารถช่วยเพิ่มค่า BMI ให้อยู่ในเกณฑ์ปกติได้"
                   .format(result),fg='black', bg='white').pack()
...
def menuform():
    ...
    label1=tk.Label(master=frame,font=('Luckiest Guy',40),text='Menu',fg='white',bg='#33A1C9').grid(row=0, padx=230,pady=(20,5))
    label2=tk.Label(master=frame,font=('Neucha',14),text='What do you wanna do today?',fg='white',bg='#33A1C9').grid(row=1, padx=220,pady=(10,5))

    btch1=tk.Button(master=w2,text='ตรวจสอบดัชนีมวลกาย',font=('Mali Regular',14),command=bmiwindow).grid(column=4,row=2,padx=(210),pady=(190,15))
    btch2=tk.Button(master=w2,text='พยากรณ์อากาศวันนี้',font=('Mali Regular',14),command=forecastwindow).grid(column=4,row=3,padx=(210),pady=(5,15))
    btch3=tk.Button(master=w2,text='วันนี้กินอะไรดี',font=('Mali Regular',14),command=randomfoodwindow).grid(column=4,row=4,padx=(210),pady=(5,15))
    btch4=tk.Button(master=w2,text='ปริมาณแคลอรี่ที่ควรได้รับ',font=('Mali Regular',14),command=calwindow).grid(column=4,row=5,padx=(210),pady=(5,15))
    
    btm=tk.Button(master=w2,text='EXIT!',font=('Luckiest Guy',15),fg='black',highlightbackground='#33A1C9',command=sys.exit).grid(column=4,row=7,padx=(200),pady=(20,15))
    w2.mainloop()
    print('ออกจาก w2')
...
def mainwindow():
    ...
    label2=tk.Label(master=w1,font=('Neucha',14),text="the manager who's gonna help you decide what to eat for each meal",fg='white',bg='#33A1C9').pack(pady=(5,5))
    label3=tk.Label(master=w1,font=('Alegreya Sans SC Regular', 15),text='Name',fg='black',bg='white').pack(pady=(60,5))
    name=tk.StringVar()
    et1=tk.Entry(w1,textvariable=name).pack()
    label4=tk.Label(master=w1,font=('Alegreya Sans SC Regular', 15),text='Age',fg='black',bg='white').pack(pady=(5))
    age=tk.StringVar()
    et2=tk.Entry(w1,textvariable=age).pack()
    label5=tk.Label(master=w1,font=('Alegreya Sans SC Regular', 15),text='Gender',fg='black',bg='white').pack(pady=(5))
    gender = tk.StringVar()
    gdb1=ttk.Combobox(textvariable=gender)
    gdb1.pack(pady=(5))
    gdb1["values"]=('ชาย','หญิง')
    label6=tk.Label(master=w1,font=('Alegreya Sans SC Regular', 15),text='Height(cm)',fg='black',bg='white').pack(pady=(5))
    height=tk.StringVar()
    et3=tk.Entry(w1,textvariable=height).pack()
    label7=tk.Label(master=w1,font=('Alegreya Sans SC Regular', 15),text='Weight(kg)',fg='black',bg='white').pack(pady=(5))
    weight=tk.StringVar()
...
def Checknamewindow():
    ...
    label1=tk.Label(master=root,font=('Luckiest Guy',30),text='Welcome to Minx!',fg='black',bg='white').pack(pady=(35,5))
    label2=tk.Label(master=root,font=('Neucha',20),text="the manager who's gonna help you decide what to eat for each meal",fg='black',bg='white').pack(pady=(5))
    label3=tk.Label(master=root,font=('Alegreya Sans SC Regular', 20),text='Name',fg='black',bg='white').pack(pady=(50, 5))
